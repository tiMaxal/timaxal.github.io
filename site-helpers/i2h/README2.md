...
MODIFIED from NathanWoodburn's ORIG INFO FILE FOR .timaxal/


## Redirect to http handshake site
`<script src="https://timaxal/i2h/redirect.js" domain="hnsdomain"></script>`

## Redirect to https handshake site
`<script src="https://timaxal/i2h/handshake.js" domain="hnsdomain"></script>`
...
`<script src="https://timaxal/i2h/https.js"></script>`
Note. This will redirect to an browser error page if your requested domain doesn't support ssl/https
