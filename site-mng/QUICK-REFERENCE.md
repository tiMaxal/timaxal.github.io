...
6. Run: `site-mng/build-site.bat` (Windows) or `site-mng/build-site.sh` (Linux/Mac)
...
OR run: `cd site-mng; ./build-site.sh`
OR run: `cd site-mng; node helper-paths-builder.js; node menu-builder.js; node sitemap-builder.js`
